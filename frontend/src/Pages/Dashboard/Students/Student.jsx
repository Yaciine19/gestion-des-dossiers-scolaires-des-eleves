      ...
      <div className="bg-white overflow-hidden shadow rounded-lg border border-primary font-poppins mb-10">
        ...
        <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
          <dl className="sm:divide-y sm:divide-gray-200">
            <StudentDetailItem
              label="Full name"
              value={student === "" ? <LineSkeleton width='w-[200px]' /> : `${fullName}`}
            />
            <StudentDetailItem
              label="Email address"
              value={student === "" ? <LineSkeleton width='w-[300px]' /> : `${student.email}`}
            />
            <StudentDetailItem
              label="Class"
              value={
            ...
            <StudentDetailItem
              label="Role"
              value={student === "" ? <LineSkeleton width='w-[150px]' /> : `${student.role}`}
            />
            <StudentDetailItem
              label="Account Status"
              value={student === "" ? <LineSkeleton width='w-[100px]' /> : `${student.status}`}
              valueClass={student.isActive ? "text-green-400" : "text-red-500"}
            />
            <StudentDetailItem
              label="Registration number"
              value={
                student === "" ? <LineSkeleton width='w-[200px]' /> : `${student.registrationNumber}`
              }
            />
            <StudentDetailItem
              label="Created at"
